...
test("J+6 reste une relance email et J+9 devient l'appel",()=>{assert.match(source,/SIGNATURE_J6_STAGE="agent_email_j6"/);assert.match(source,/SIGNATURE_J9_STAGE="phone_call_j9"/);assert.match(source,/if\(!isDue\(row\.due_at\)\)return\[\]/)});
