  ...
  return (
    <main style={{minHeight:"100vh",display:"grid",placeItems:"center",padding:24,background:"radial-gradient(circle at top, rgba(201,148,58,0.18), transparent 34%), var(--selen-bg)",color:"var(--selen-text)"}}>
      <section style={{width:"100%",maxWidth:440,border:"1px solid var(--selen-border)",borderRadius:"var(--radius-lg)",padding:28,background:"var(--selen-card)",boxShadow:"0 24px 80px rgba(0,0,0,0.28)"}}>
        ...
        <h1 style={{fontFamily:"var(--font-display)",fontSize:30,lineHeight:1.15,color:"var(--selen-gold)",marginBottom:10}}>Connexion agent</h1>
        <p style={{fontSize:14,lineHeight:1.6,color:"var(--selen-text2)",marginBottom:24}}>Accède au back-office Selen pour gérer les clients, les dossiers et les audits blancs.</p>
        ...
        <p style={{marginTop:18,fontSize:12,lineHeight:1.5,color:"var(--selen-text3)"}}>Espace réservé aux agents et administrateurs Selen.</p>
      </section>
    </main>
  );
}
