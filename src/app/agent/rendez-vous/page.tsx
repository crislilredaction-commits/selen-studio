          ...
          filtered.map((row) => {
            ...
            return (
              <SelenCard key={row.id}>
                ...
                <div style={s.grid}>
                  <Info label="Prénom" value={first(row, ["first_name", "firstname", "prenom"])} />
                  <Info label="Nom" value={first(row, ["last_name", "lastname", "nom"])} />
                  <Info label="Email" value={first(row, ["email", "client_email"])} />
                  <Info label="Téléphone" value={first(row, ["phone", "telephone", "tel"])} />
                  <Info label="Source" value={first(row, ["source", "origin"])} />
                  ...
                  <Info label="dossier_id" value={first(row, ["dossier_id"])} mono />
                  <Info
