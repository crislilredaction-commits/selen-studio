...
export default function DailyStudioLayout({ children }: { children: ReactNode }) {
  return (
    <>
      <div style={{maxWidth:1180,margin:"14px auto 0",padding:"0 28px",display:"flex",gap:8,flexWrap:"wrap"}}>
        ...
        <Link href="/agent/daily/qualite" style={linkStyle}>Qualité & veilles</Link>
      </div>
      {children}
    </>
  );
