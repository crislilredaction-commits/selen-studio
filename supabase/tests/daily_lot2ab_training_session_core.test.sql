...
('18000000-0000-4000-8400-000000000034','18000000-0000-4000-8400-000000000010','trainer-other@example.invalid','Trainer Other','draft','external');
...
insert into public.daily_formations(
 ...
 results_pending,contact_phone,contact_email,status,allowed_trainer_ids
) values (
 ...
 '["18000000-0000-4000-8400-000000000031"]'::jsonb
);
...
select is((select jsonb_array_length(allowed_trainer_ids) from public.daily_formations where id='18000000-0000-4000-8400-000000000040'),1,'formation stores allowed trainers');
...
select is((select jsonb_array_length(trainer_ids) from public.daily_sessions where id='18000000-0000-4000-8400-000000000050'),1,'session accepts allowed active trainer from same organisation');
...
select throws_ok($$update public.daily_sessions set trainer_ids='["18000000-0000-4000-8400-000000000034"]'::jsonb where id='18000000-0000-4000-8400-000000000050'$$,'P0001','session trainer is not allowed for this formation','same-organisation trainer not allowed by formation is rejected');
