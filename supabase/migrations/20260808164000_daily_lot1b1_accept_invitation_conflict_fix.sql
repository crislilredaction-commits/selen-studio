-- Daily Lot 1B.1: disambiguate membership_id inside the table-returning invitation RPC.
-- Named constraints avoid collisions with the PL/pgSQL output parameter membership_id.
...
begin
  ...
  where om.organisation_id = candidate.organisation_id
